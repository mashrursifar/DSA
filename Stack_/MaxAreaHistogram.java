...
public class MaxAreaHistogram {
    ...
    public static void leftSmaller(int h[], int nextSL[],int n){
    ...
    public static void rightSmaller(int h[], int nextSR[],int n){
    ...
    public static int area(int h[]){
        ...
        leftSmaller(h, nextSL, n);
        rightSmaller(h, nextSR, n);
